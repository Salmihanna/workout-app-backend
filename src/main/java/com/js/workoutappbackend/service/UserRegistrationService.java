...
public class UserRegistrationService {
    ...
    private final static String CONFIRM_MSG = "Confirm";
  ...
  public String register(UserRegistrationRequest request) {
        ...
        linkToRegistration = LINK + token;
        /*emailRepository.send(request.getEmail(),
                buildEmail(request.getFirstName(), linkToRegistration));*/
...
//        myUserDetailService.activateUser(
